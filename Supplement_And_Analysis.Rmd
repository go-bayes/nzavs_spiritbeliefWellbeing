---
title             : "Supplement: Analysis for National Longitudinal Evidence for Growth in Subjective well-being from Spiritual Belief"
...
conflicts()
furniture::table1(d_3, splitby = ~Wave,
                    Age, 
                    NZdep,
                    Education,
                    Employed,
...
In the the reported analyses, we included covariates to adjust for potential confounding effects from usual suspect factors associated with our two measures of well-being (Personal Well-Being, Life Satisfaction). Where $Z$ is a third variable, $X$ is the predictor, and $Y$ is the outcome, there are at least four types of confounding that might arise: 
