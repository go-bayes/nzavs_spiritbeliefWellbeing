---
title             : "Longitudinal Evidence for Growth in Subjective Wellbeing from Spiritual Belief"
...
wordcount         : "5415 words in text body, 1155 words in reference section"
...
1. At the outset of the study, in 2010, the expected subjective well-being as measured using the personal well-being Inventory was expected to be lower among those who believed in Spirit or Life Force but not a God ($\hat{y}$ =  6.78 [6.74, 6.82]) and lower among those who believed in both a Spirit/Life-Force and a God ($\hat{y}$ =  6.75 [6.72, 6.78]) in comparison both to the skeptical population who neither believed in a God nor a life force ($\hat{y}$ = 6.91 [6.86, 6.95]) and to the population that believed in a God but was skeptical about belief in a Spirit or Life Force ($\hat{y}$ 6.88 [6.81, 6.96]). (See Figure 2)  Similarly,the expected subjective well-being as measured using the life satisfaction Inventory was lowest in 2010 among those who believed in Spirit or Life Force but not a God ($\hat{y}$ = 5.07 [5.04, 5.10]). Life satisfaction was similar among those who believed in both a Spirit/Life-Force and a God  ($\hat{y}$ =  5.11 [5.08, 5.13]) in comparison both with the skeptical population who neither believed in a God nor a life force ($\hat{y}$ = 5.12 [5.08, 5.15]). Life satisfaction was highest among the population that believed in a God but was skeptical about belief in a Spirit or Life Force ($\hat{y}$ 5.19 [5.14, 5.25]) (see Figure 3)

2. However, over time, belief in a Spirit or Life Force predicts a trajectory of growth in personal well-being. In 2018, personal well-being among who believe in Spirit or Life Force but not a God had grown to ($\hat{y} = 7.13$ [7.09, 7.16], $\Delta \hat{y} = 0.35$). Among those who believed in both a Spirit/Life-Force and a God, personal well-being had grown to ($\hat{y} =  7.14$, [7.11, 7.16], $\Delta \hat{y} = 0.39$). By contrast, personal well-being among the skeptical population who neither believed in a God nor a Life Force grew less steeply across the eight year interval $\hat{y} = 7.15 [7.12, 7.19]$, $\Delta \hat{y} = 0.24$). By the same token, personal well-being among those who believe in a God but are skeptical about a Spirit/Life Force grew less steeply $\hat{y} = 7.15$, [7.09, 7.21] $\Delta \hat{y} = 0.27$). Similarly, over time, belief in a Spirit or Life Force predicts a trajectory of growth in life satisfaction. In 2018, the expected effect of spiritual beliefs on life satisfaction among those who believe in Spirit or Life Force but not a God had grown to ($\hat{y} =  5.30$ [5.28, 5.33], $\Delta \hat{y} = 0.23$). In practical terms, such growth is equivalent to the expected gain in life satisfaction from being employed and a sixth as large as the expected benefit to life satisfaction from having a romantic partner. In practical termss, the rate of increase in personal wellbeing among those with Spirit/Life force beliefs was about one and half times greater than it was among those who lacked such beliefs (See Figure 2). Among those who believed in both a Spirit/Life-Force and a God, life satisfaction had grown to ($\hat{y} = 5.33 [5.31, 5.35]$, $\Delta \hat{y} = 0.22$). By contrast, life satisfaction among the skeptical population who neither believed in a God nor a Life Force lagged behind over the eight year interval $\hat{y} =  5.24 [5.21, 5.27], \Delta \hat{y} = 0.12$). Relatedly, life satisfaction in the population that believe in God but are skeptical about a Spirit/Life Force grew less steeply $\hat{y} =  5.32 [5.27, 5.36], \Delta \hat{y} = 0.13$). In practical terms, the rate of increase in life satisfaction among those with Spirit/Life force beliefs was twice as large (See Figure 3).
